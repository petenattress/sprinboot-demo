...
<head>
  ...
  <link rel="shortcut icon" href="/webjars/govuk-frontend/1.0.0/images/favicon.ico" type="image/x-icon" />
  <link rel="mask-icon" href="/webjars/govuk-frontend/1.0.0/images/govuk-mask-icon.svg" color="blue">
  <link rel="apple-touch-icon" sizes="180x180" href="/webjars/govuk-frontend/1.0.0/images/govuk-apple-touch-icon-180x180.png">
  <link rel="apple-touch-icon" sizes="167x167" href="/webjars/govuk-frontend/1.0.0/images/govuk-apple-touch-icon-167x167.png">
  <link rel="apple-touch-icon" sizes="152x152" href="/webjars/govuk-frontend/1.0.0/images/govuk-apple-touch-icon-152x152.png">
  ...
  <!--[if IE 8]>
  <link href="/webjars/govuk-frontend/1.0.0/govuk-frontend/all-ie8.css" rel="stylesheet" />
  <![endif]-->

  <!--[if lt IE 9]>
  <script src="/webjars/govuk-frontend/1.0.0/html5-shiv/html5shiv.js"></script>
  <![endif]-->
      ...
      <a href="#" class="govuk-header__link govuk-header__link--homepage">
          <span class="govuk-header__logotype">
            ...
            <svg role="presentation" focusable="false" class="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 132 97" height="32" width="36">
              ...
              <image src="/webjars/govuk-frontend/1.0.0/assets/images/govuk-logotype-crown.png" class="govuk-header__logotype-crown-fallback-image"></image>
            </svg>
...
<script src="/webjars/govuk-frontend/1.0.0/govuk-frontend/all.js"></script>
